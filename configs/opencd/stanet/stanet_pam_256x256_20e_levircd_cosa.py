_base_ = './stanet_pam_256x256_40k_levircd.py'

# Enable CoSA in STANet decode head
model = dict(
    decode_head=dict(
        use_cosa=True,
        cosa_topk=32,
...
# Load baseline checkpoint (use absolute path or find latest)
load_from = 'results/opencd_integration/stanet_pam_baseline/best_mIoU_iter_40000.pth'
